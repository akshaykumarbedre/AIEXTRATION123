        ...
        <section className="w-full max-w-5xl flex flex-col md:flex-row items-center justify-between gap-8 py-12">
          <div className="md:w-1/2">
            ...
            <p className="text-lg mb-8 text-gray-600 dark:text-gray-300">
              Transform unstructured text into structured, schema-based data using advanced AI models.
            </p>
          ...
          <div className="md:w-1/2 flex justify-center">
            <div className="relative w-full max-w-md h-64 bg-gradient-to-br from-blue-100 to-teal-100 dark:from-blue-900/30 dark:to-teal-900/30 rounded-xl shadow-lg p-6 flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="text-blue-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Create a structured schema with field names, types, and descriptions.
              </p>
              <Link href="/schema" className="text-blue-600 hover:text-blue-700 font-medium inline-flex items-center gap-1">
                Define Schema
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Input your unstructured text and let AI convert it to structured data.
              </p>
              <Link href="/extract" className="text-teal-600 hover:text-teal-700 font-medium inline-flex items-center gap-1">
                Extract Now
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M5 12h14"></path>
                  <path d="m12 5 7 7-7 7"></path>
            ...
            >
              ...
              <Link href="/api-docs" className="text-purple-600 hover:text-purple-700 font-medium inline-flex items-center gap-1">
                View API Docs
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M5 12h14"></path>
                  <path d="m12 5 7 7-7 7"></path>
        ...
        <section className="w-full max-w-5xl py-12 border-t border-gray-200 dark:border-gray-800">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16">
            <div className="flex flex-col items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-blue-600 mb-2">
