                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-4">
                    {fields.map((field, index) => (
                      <div
                        key={index}
                        className="flex gap-3 p-4 bg-gray-50 rounded-lg shadow-sm"
                      >
              ...
              {schemaResponse && (
                <div className="mt-8 p-6 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  <p className="mt-4 text-sm text-gray-600">
                    Your schema has been successfully created. You can now
            ...
            <div>
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                <h2 className="text-2xl font-bold text-gray-800 mb-4 md:mb-0">
                  Results{' '}
                  <span className="text-lg text-teal-500 font-normal ml-1">
              ...
              {processedResults.length > 0 ? (
                    ...
                    <thead>
                      <tr className="bg-gray-50">
                        {Object.keys(processedResults[0]).map((key) => (
                          <th
                            key={key}
                            className="border-b px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider"
                          >
                            {key}
                          </th>
                        ))}
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {processedResults.map((result, resultIndex) => (
                        <tr
                          key={resultIndex}
                          className={
                            resultIndex % 2 === 0 ? 'bg-white' : 'bg-gray-50'
                          }
                        >
                ...
                <div className="flex flex-col items-center justify-center py-12 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  <p className="text-gray-400 text-sm mt-2">
                    Process some text first to see results here.
                  </p>
                </div>
              )}
            </div>
